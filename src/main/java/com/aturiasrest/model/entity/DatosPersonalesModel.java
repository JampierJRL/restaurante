...
public class DatosPersonalesModel {
	...
	private TipoDocumentoModel codTipoDocumento; 
	...
	@Column(name = "fecha_egreso", columnDefinition = "DATETIME")
	...
	@Column(name = "estado_persona", columnDefinition = "TINYINT default 1")
	...
	public DatosPersonalesModel(int numeroDocumento, TipoDocumentoModel codTipoDocumento, String primerNombre,
			String sexoDescripcion, Date fechaNacimiento, String direccion, String telefono, String ruc,
			@Email String email, Date fechaIngreso, Date fechaEgreso, String segundoNombre, String apellidoPaterno,
			String apellidoMaterno, String razonSocial, String celular, boolean estadoPersona,
	...
	public TipoDocumentoModel getCodTipoDocumento() {
		return codTipoDocumento;
	}

	public void setCodTipoDocumento(TipoDocumentoModel codTipoDocumento) {
		this.codTipoDocumento = codTipoDocumento;
	}
	...
	public String toString() {
		return "DatosPersonalesModel [numeroDocumento=" + numeroDocumento + ", codTipoDocumento=" + codTipoDocumento
